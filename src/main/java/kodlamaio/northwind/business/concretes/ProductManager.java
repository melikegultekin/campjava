...
public class ProductManager implements ProductService{
	...
	public DataResult<List<Product>> getByProductNameStartWith(String productName) {
		return new SuccessDataResult<List<Product>>(this.productDao.getByProductNameStartWith(productName),"Data listelendi");
	}
	...
	public DataResult<List<Product>> getAll(int pageNo, int pageSize) {
		...
		return new SuccessDataResult<List<Product>>(this.productDao.findAll().getContext());
	}
